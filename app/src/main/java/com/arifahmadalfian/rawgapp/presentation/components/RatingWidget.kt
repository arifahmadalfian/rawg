...
import com.arifahmadalfian.rawgapp.domain.utils.EMPTY_STARS
import com.arifahmadalfian.rawgapp.domain.utils.FILLED_STARS
import com.arifahmadalfian.rawgapp.domain.utils.HALF_FILLED_STARS
import com.arifahmadalfian.rawgapp.presentation.ui.theme.StarColor
...
fun calculateStars(rating: Double): Map<String, Int> {
    ...
    LaunchedEffect(key1 = rating) {
        ...
        if (firstNumber in 0..5 && lastNumber in 0..9) {
            ...
            Timber.d("RattingWidget Invalid rating number")
        }
    }
